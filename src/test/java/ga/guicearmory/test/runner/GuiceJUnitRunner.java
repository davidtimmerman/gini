package ga.guicearmory.test.runner; /**
...
public class GuiceJUnitRunner extends BlockJUnit4ClassRunner {
    ...
    /**
     * Gets the Guice module for the given test class.
     *
     * @param klass
     *            The test class
     * @return The array of Guice {@link com.google.inject.Module} module used to initialize the
    ...
    private Class<?>[] getModulesFor(Class<?> klass) throws InitializationError {
        ...
        if (annotation == null)
            throw new InitializationError(
                    "Missing @ga.guicearmory.test.runner.GuiceModules annotation for unit test '" + klass.getName()
                            + "'");
